  ...
  <div className={homeStyle.container}>
        ...
        >
          <font color="#00ff00">
            ...
            <font color="#fff">
              ...
              <Link to="https://www.facebook.com/saylaniwelfare/photos/a.258515937507690/3441173892575196/?type=3&theater">
                More Details {"   "}
              </Link>
            </font>
          </font>
    ...
    <div className={homeStyle.introduction}>
      ...
      <div>
        ...
        <p>
          ...
          social welfare free of cost to people living in the dark. With over 60
    ...
    <div className={homeStyle.counter}>
      ...
      <div>
        ...
        <h2>7,500</h2>
        <h5>
          FAMILY ADOPTION <span className={homeStyle.counterH5}>(MONTHLY)</span>
        </h5>
      </div>
      <div>
        <img
    ...
    <div className={homeStyle.doing}>
      ...
      <div className={homeStyle.doingWrap}>
        <div className={homeStyle.doingItem}>
          <Link>
            <img
              src={require("../assets/images/icons/onlinesadqah.png")}
              alt="online sadqa"
            />
          </Link>
          <h4>ONLINE SADQAH</h4>
        ...
        <div className={homeStyle.doingItem}>
          <Link>
            <img
              src={require("../assets/images/icons/welfare.png")}
              alt="welfare"
            />
          </Link>
          <h4>WELFARE</h4>
        ...
        <div className={homeStyle.doingItem}>
          <Link>
            <img
              src={require("../assets/images/icons/medical.png")}
              alt="medical"
            />
          </Link>
          <h4>MEDICAL</h4>
        ...
        <div className={homeStyle.doingItem}>
          <Link>
            <img
              src={require("../assets/images/icons/Dastarkhwan.png")}
              alt="dastarkhwan"
            />
          </Link>
          <h4>DASTARKHWAN</h4>
        ...
        <div className={homeStyle.doingItem}>
          <Link>
            <img
              src={require("../assets/images/icons/ROPLANT.png")}
              alt="ro plant"
            />
          </Link>
          <h4>RO PLANT</h4>
        ...
        <div className={homeStyle.doingItem}>
          <Link>
            <img
              src={require("../assets/images/icons/education.png")}
              alt="education"
            />
          </Link>
          <h4>EDUCATION</h4>
          ...
          <div className={homeStyle.missionItemWrap}>
            <div className={homeStyle.missionItem}>
              <div className={homeStyle.mediaLeft}>
                <img
                  src={require("../assets/images/icons/Hepatitis.png")}
                  alt="hepatitis"
                />
              </div>
            ...
            <div className={homeStyle.missionItem}>
              <div className={homeStyle.mediaLeft}>
                <img
                  src={require("../assets/images/icons/housing.png")}
                  alt="housing"
                />
              </div>
              <div className={homeStyle.mediaBody}>
            ...
            <div className={homeStyle.missionItem}>
              <div className={homeStyle.mediaLeft}>
                <img
                  src={require("../assets/images/icons/tharparkar.png")}
                  alt="tharparkar"
                />
              </div>
              <div className={homeStyle.mediaBody}>
