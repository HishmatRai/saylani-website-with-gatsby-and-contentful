        ...
        <MDBRow style={{ width: "98%",}}>
            <MDBCol xl="8" >
                <div className={style.mainDiv}>
                    <h2 className={style.heading}>Donation For Sadqa</h2>
                    {/* **************************************************************** Donation Type */}
                    ...
                    {/* *******************************************************  Sadqa  */}
                    <div className={style.inputDiv}>
                        <label className={style.label1}>Sadqa <small style={{ color: 'red', fontSize: '18px' }}>*</small></label>
                        <br />
                        <select className={style.input1}>
                            <option>Select option</option>
            ...
            <MDBCol xl="4" >
                <div className={style.paymentmethoodDiv}>
                    ...
                    <div className={style.butonDonate}>   for UK Donors [Qurbani, Sadqah, Zakat]<br />
